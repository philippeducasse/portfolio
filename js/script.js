let projects = [
    ...
    },
    {
        id: 4,
        name: 'ChattyApp',
        description: 'In this project I created an App for mobile devices using React Native. The app provides users with a chat interface and options to share images and their location.',
        technologies: [
            'React Native',
